<h2><a href="https://leetcode.com/problems/calculate-digit-sum-of-a-string">Calculate Digit Sum of a String</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>You are given a string <code>s</code> consisting of digits and an integer <code>k</code>.</p>
